...
const {
  ...
  return (
    ...
    {...listeners}
    >
    <div className='relative min-w-[80px] min-h-[80px] rounded-md flex flex-col items-center justify-center bg-light-bg_2 dark:bg-dark-bg_2 px-4 py-3 text-light-text dark:text-dark-text'>
      <button

                ...
                products.map((item, index)=>{
                    if (indicator === "All") {
                       return ( <motion.div
                        ...
                        className='relative product_shadow dark:product_shadow_dark min-w-[430px] rounded-3xl px-8 md:px-12 py-8 md:py-12 flex flex-col items-center justify-center mt-[150px] mx-0 md:mx-[20px] cursor-pointer'
                    >
            
                        <Image
                        // relative top-[-50%] left-[50%] translate-x-[-50%] translate-y-[-50%]
                        className='mt-[-130px] mb-[30px] boxShadow_i rounded-full'
